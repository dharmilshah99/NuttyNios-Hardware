...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios2system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios2system
SOPC_NAME := nios2system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x21098
SOPC_SYSID_FLAG += --sidp=0x21098
ELF_PATCH_FLAG  += --sidp 0x21098

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1645205399
SOPC_SYSID_FLAG += --timestamp=1645205399
ELF_PATCH_FLAG  += --timestamp 1645205399
